...
npm -v
npx -v
![alt text](screenshots\README\README-verifyInstallPythonNode.png)
...
![alt text](screenshots\README\README-pipinstallrequirements.png)
3) rfbrowser init (do not connect to VPN/CDB network, use CMD not Powershell!)
![alt text](screenshots\README\README-rfbrowserinit.png)
4) verify: rfbrowser --version (use CMD not bash or powershell!)
![alt text](screenshots\README\README-rfbrowser--version.png)


## Set up Qase integration
5) pip install qase-robotframework
![alt text](screenshots\README\README-pipinstallqase-robotframework.png)
